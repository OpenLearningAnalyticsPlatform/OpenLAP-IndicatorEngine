        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $("#gla_EventData").dataTable( {
                    ...
                    "sAjaxSource": "/toolkit/fetchGlaEventData.web",
                    "aoColumns": [
                        { "mData": "id" },
                        { "mData": "action" },
                        { "mData": "session" },
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>View Events</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <h1>View Event Data</h1>
            <p>Here you can view all events present in gla_events.</p>
            <div class="row">
                <div class="col-md-12">
                    <form:form action="" method="GET">
                        <h2 >Listing of All Event Data from gla_Event Table<br><br></h2>
                        <table width="70%" style="border: 3px;background: rgb(243, 244, 248);"><tr><td>
                            <table id="gla_EventData" class="display" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>EVENT_ID</th>
                                    <th>ACTION</th>
