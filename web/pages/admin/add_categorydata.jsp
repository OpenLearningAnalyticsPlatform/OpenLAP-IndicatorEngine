...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>Add Category Data</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <p>Here you can add a new "category" to the data set. Every Category has a Type, Major and Minor. </p>
            <div class="row">
                <div class="col-md-12">
                    <form:form role="form" id="dataset-addnewCategoryForm"  method="post" commandName="addCategoryDataForm" action="/toolkit/add_categorydata">
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="Type">Select a Type</label>
                                    <form:select class="form-control margin-bottom-15" path="selectedType" items="${addCategoryDataForm.type}" id="Type" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="Major">Select A Major</label>
                                <form:select class="form-control margin-bottom-15" path="selectedMajor" items="${addCategoryDataForm.major}" name="major" id="Major" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="minor" class="control-label">Minor</label>
                                <form:input path="minor" type="text" class="form-control" name ="minor" id="minor" />
                            </div>
                        </div>
