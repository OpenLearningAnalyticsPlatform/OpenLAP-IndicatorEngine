...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>Add a New User</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <p> Here you can add a new user to the data set. Every user has a username, password and a email address.</p>
            <div class="row">
                <div class="col-md-12">
                    <form:form role="form" id="dataset-addnewuserForm"  method="post" commandName="addUserDataForm" action="/toolkit/add_userdata">
                        <div class="row">
