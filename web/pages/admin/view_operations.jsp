        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $("#gla_userData").dataTable( {
                    ...
                    "sAjaxSource": "/toolkit/fetchGlaOperationsData.web",
                    "aoColumns": [
                        { "mData": "id" },
                        { "mData": "operations" },
                    ]
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>View Operations</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <p>You can view all the Operations present in GLA_OPERATIONS.</p>

            <div class="row">
                <div class="col-md-12">
                    <form:form action="" method="GET">
                        <h2 >Listing of All Operations from gla_OPERATIONS Table<br><br></h2>
