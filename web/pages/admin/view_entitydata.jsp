        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $("#gla_EntityData").dataTable( {
                    ...
                    "sAjaxSource": "/toolkit/fetchGlaEntityData.web",
                    "aoColumns": [
                        { "mData": "entityId" },
                        { "mData": "key" },
                        { "mData": "value" },
                        { "mData": "glaEvent.id" },
                        { "mData": "glaEvent.glaUser.id" },
                        { "mData": "glaEvent.glaCategory.id" },
                    ]
                } );
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>View Entity</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <h1>View Entity Data</h1>
            <p>Here you can view all entities present in gla_Entity.</p>
            <div class="row">
                <div class="col-md-12">
                    <form:form action="" method="GET">
                        <h2 >Listing of All Entity Data from gla_Entity Table<br><br></h2>
                        <table width="70%" style="border: 3px;background: rgb(243, 244, 248);"><tr><td>
                            <table id="gla_EntityData" class="display" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>ENTITY_ID</th>
                                    <th>KEY</th>
