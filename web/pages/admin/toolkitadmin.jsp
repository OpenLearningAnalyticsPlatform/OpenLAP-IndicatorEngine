...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <h1>Goal LA Tookit Admin Center</h1>
            ...
            <figure>
                <img src="${pageContext.request.contextPath}/images/ER.png" alt="Learning Context Entity - Relationship Model">
                <figcaption> Learning Context Entity - Relationship Model </figcaption>
            </figure>
            </div>
            </div>
        </div>
