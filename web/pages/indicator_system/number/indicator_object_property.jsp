...
<head>
    ...
    <title>Properties of Persistence Object</title>
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>Properties of Persistence Object</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <h1>Properties of Persistence Object</h1>
            <p>Select required properties of the previously selected Persistence Object.</p>
            <div class="row">
                <div class="col-md-12">
                    <form:form role="form" id="objectSelectionform"  method="post" modelAttribute="selectNumberParameters" action="${flowExecutionUrl}">
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="objectSelection">Select Properties of the Persistence Object </label>
                                <form:select class="form-control margin-bottom-15" path="selectedRetrievableObjects" items="${selectNumberParameters.retrievableObjects[selectNumberParameters.selectedPersistenceObject]}" name ="objectSelection" id="objectSelection" />
                            </div>
                        </div>
                        <p>
