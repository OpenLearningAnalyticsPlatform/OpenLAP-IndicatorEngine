                                    ...
                                    <tbody>
                                        <tr>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 margin-bottom-15">
                                                    <button class="waves-effect waves-light btn" type="button" title="Click to add new current Indicator."
                                                            name="addIndicator" id="addIndicator" value="New Indicator"  onclick="addNewIndicator()" >Add Indicator
                                                    </button>
                                ...
                                <div class="panel-heading">Indicator</div>
                                    <div class="panel-body">
                                        <ul class="collapsible" data-collapsible="expandable">
                                            ...
                                            <li>
                                                <div class="collapsible-header">Method</div>
                                                <div class="collapsible-body panel-body">
                                                    <table class="table table-striped">
                                                        <tbody>
                                                        <tr>
                                            ...
                                            <li>
                                                <div class="collapsible-header">Visualization</div>
                                                <div class="collapsible-body panel-body">
                                                    <table class="table table-striped">
                                                        <tbody>
                                                        <tr>
