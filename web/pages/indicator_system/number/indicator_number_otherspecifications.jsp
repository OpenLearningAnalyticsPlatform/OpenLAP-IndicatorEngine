...
<head>
    ...
    <title>Timestamp Specifications</title>
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>TimeStamp Specifications</h1></div>
...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <h1>Specify Timestamp Based Filters</h1>
            <p>Based on your previous selection, here you can choose  and
                specify upto 10 time based search criteria here.</p>
            <div class="row">
                <div class="col-md-12">
                    <form:form role="form" id="timeSelection"  method="POST" commandName="selectNumberParameters" action="${flowExecutionUrl}">

                        <div class="col-md-6 col-sm-6 margin-bottom-30">
                            <div class="panel panel-primary">
                                <div class="panel-heading">Timestamp Filtering Selection</div>
                                <div class="panel-body">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <div class="col-md-12">
                                                <input type="submit" name="_eventId_searchTime"
                                                       value="Search" />
                                            </div>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <div class="row templatemo-form-buttons">
                                                <div class="col-md-12">
                                                    <input  type="submit" name="_eventId_specifyTime"
                                                           value="Add Time Specification" />
                                                </div>
                                            </div>
                                        </tr>
                                        <tr>
                                            <div class="row templatemo-form-buttons">
                                                <div class="col-md-12">
                                                    <input  type="submit" name="_eventId_clearTimeValues"
                        ...
                        <div class="col-md-6 col-sm-6 margin-bottom-30">
                            <div class="panel panel-primary">
                                <div class="panel-heading">Entered Time Based Parameters</div>
                                <div class="panel-body">
                                    <table class="table table-striped">
                                        <thead>
                                        <tr>
                        ...
                        <div class="row templatemo-form-buttons">
                            <div class="col-md-12">
                                <input cclass="btn btn-default" type="submit" name="_eventId_prevScreen"
                                       value="Previous" />
                                <input class="btn btn-primary" type="submit" name="_eventId_TimeSpecified"
                                       value="Next" />
                            </div>
                        </div>
                    </form:form>
