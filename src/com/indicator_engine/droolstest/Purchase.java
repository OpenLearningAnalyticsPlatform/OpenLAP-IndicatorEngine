...
package com.indicator_engine.droolstest;
    ...
    public void testRules() {
        ...
        try {
            KnowledgeBuilder builder = KnowledgeBuilderFactory.
                    newKnowledgeBuilder();
            builder.add(ResourceFactory.newClassPathResource("com/indicator_engine/droolsrules/discountRules.drl"), ResourceType.DRL);
